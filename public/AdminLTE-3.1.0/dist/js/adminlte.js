...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem = "<li class=\"nav-item dropdown-hover\" role=\"presentation\">" +
      		"<a href=\"#\" class=\"btn-iframe-close hide\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link dropbtn\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a>" 
      		+ `<div class="dropdown-content">
      <a href="javascript:void(0)" data-id="#${tabId}" class="reloading-iframe-btn">Tải lại</a>
      <a href="#" class="closing-iframe-btn">Đóng tab</a>
      </div>`+"</li>";
